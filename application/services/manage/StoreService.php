...
class StoreService extends BaseService
{
    ...
    public function create(){
        $request = Request();
        $data = $request->only(['type','uid','mobile','title','logo','code','address','map','address_img','dishes_img','elm_code',
            'mt_code','thumb','status']);
    ...
    public function update(){
        $request = Request();
        $data = $request->only(['id','type','uid','mobile','title','logo','code','address','map','address_img','dishes_img','elm_code',
            'mt_code','thumb','status']);
        $logo_arr = explode(',',$data['logo']);
        $address_img_arr = explode(',',$data['address_img']);
        $dishes_img_arr = explode(',',$data['dishes_img']);
